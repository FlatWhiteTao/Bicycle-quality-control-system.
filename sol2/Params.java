...
public class Params {
	...
	// the segment number of the placement of the sensor on the belt
	public final static int SEN_LOC = 3;
	
	// the length of the main belt
	public final static int MBT_LEN = 5;
	
	// the length of the short belt
	public final static int SBT_LEN = 2;
